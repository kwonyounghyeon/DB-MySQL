...
CREATE TABLE `movie` (
	...
	`mo_name`	varchar(50)	NULL,
	`mo_contents`	longtext	NULL,
	`mo_age`	varchar(10)	NULL,
	`mo_showtime`	int	NULL,
	`mo_openning_date`	date	NULL,
...
CREATE TABLE `movie_genre` (
	...
	`mg_ge_name`	varchar(100)	NOT NULL,
...
CREATE TABLE `region` (
	`re_name`	varchar(100)	NOT NULL  primary key
);
...
ALTER TABLE `steelcut` ADD CONSTRAINT `FK_movie_TO_steelcut_1` FOREIGN KEY (
	`st_mo_num`
)
REFERENCES `movie` (
	`mo_num`
