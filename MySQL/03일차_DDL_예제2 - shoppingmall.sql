-- 이전에 작성된 데이터베이스를 삭제하고싶다면 drop 진행
...
create table if not exists member(
	...
	me_pw varchar(15) not null, -- 비밀번호
    me_name varchar(15) not null, -- 이름
...
create table if not exists product(
    ...
    pr_amount int not null default 0, -- 제품 수량
...
bu_postcode varchar(5) not null,
